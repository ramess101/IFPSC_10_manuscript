...
%	As the Mie 16-6 potential predicts $\eta$ more accurately than the Lennard-Jones 12-6 potentials, 
	...
	The $A_{\rm s}$ parameter sets for MCMC-nb-tors are obtained using SciPy's skewnorm.rvs function in the stats sub-packaged \footnote{https://docs.scipy.org/doc/scipy/reference/generated/scipy.stats.skewnorm.html}. The parameter values supplied to this function are provided in Table BLANK.
	...
	\begin{table}[htb!]
		...
		\begin{center}
			\begin{tabular}{|c|c|c|c|}
				\hline
				Torsion sites & $\rm{a}$ & 	$\rm{loc}$ & $\rm{scale}$ \\ \hline
				CH$_i$-CH$_2$-CH-CH$_j$ &  & & \\
				CH$_i$-CH$_2$-C-CH$_j$ & & & \\
				\hline
			\end{tabular}
		\end{center} 
